...
public class Auction {
	...
	public Auction(int auctionNo, String auctionTitle, String auctionWriter, String auctionBuyer, int auctionPrice,
			int auctionDirectPrice, int auctionIngPrice, int auctionUnitPrice, String auctionContent,
			int auctionReadcount, Date auctionDate, Date auctionEndDate, String auctionType, String auctionCategory,
			Date auctionDeldate, String auctionDeltype, String auctionAddress) {
		super();
		...
		this.auctionIngPrice = auctionIngPrice;
	...
	public String toString() {
		return "Auction [auctionNo=" + auctionNo + ", auctionTitle=" + auctionTitle + ", auctionWriter=" + auctionWriter
				...
				+ auctionDirectPrice + ", auctionIngPrice=" + auctionIngPrice + ", auctionUnitPrice=" + auctionUnitPrice
	...
	public int getAuctionIngPrice() {
		return auctionIngPrice;
	}


	public void setAuctionIngPrice(int auctionIngPrice) {
		this.auctionIngPrice = auctionIngPrice;
	}
